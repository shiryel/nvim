...
local groups = {
  ...
  ['NormalFloat'] = { link = 'Normal', bg = a.popup_bg },                           -- Normal text in floating windows.
...
vim.api.nvim_create_autocmd('InsertLeave',
  { pattern = '*', callback = function() vim.api.nvim_set_hl(0, 'statusline', { bg = a.panel_border_focus, fg = c.gray_0 }) end })
