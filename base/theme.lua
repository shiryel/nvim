...
local groups = {
  ...
  ['DiffChange'] = { fg = c.cyan },                                -- Diff mode: Changed line. |diff.txt|
  ...
  ['IncSearch'] = { bg = c.chartreuse },                           -- 'incsearch' highlighting; also used for the text replaced with ":s///c".
  ['Substitute'] = { bg = c.chartreuse_l },                        -- |:substitute| replacement text highlighting.
  ...
  ['MatchParen'] = { bg = c.chartreuse },                          -- Character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
  ...
  ['Normal'] = { fg = a.text },                                    -- Normal text.
  ['NormalFloat'] = { link = 'Normal' },                           -- Normal text in floating windows.
  ['FloatBorder'] = { fg = a.popup_border, bg = a.popup_border },  -- Border of floating windows.
  ['FloatTitle'] = { fg = a.text, bold = true },                   -- Title of floating windows.
  ['FloatFooter'] = { fg = a.text, italic = true },                -- Footer of floating windows.
  ['NormalNC'] = { fg = a.text_no_focus },                         -- Normal text in non-current windows.
  ['Pmenu'] = { bg = a.popup_bg, fg = a.text },                    -- Popup menu: Normal item.
  ...
  ['StatusLine'] = { bg = c.panel_border_focus },                  -- Status line of current window.
  ['StatusLineNC'] = { bg = a.panel_border },                      -- Status lines of not-current windows.
  ...
  ['TabLineFill'] = { bg = a.pane_bg },                            -- Tab pages line, where there are no labels.
  ...
  ['@markup.heading.0'] = {},                            -- top-level heading
  ['@markup.heading.1'] = {},                            -- section heading
  ['@markup.heading.2'] = {},                            -- subsection heading
  ['@markup.heading.3'] = {},                            -- and so on
  ['@markup.heading.4'] = {},                            -- and so forth
  ['@markup.heading.5'] = {},                            -- six levels ought to be enough for anybody
