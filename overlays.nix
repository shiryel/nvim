...
in
{
  ...
  elixir-expert-lsp = with final; let
    beam = beam26Packages;
    erlang = beam.erlang;
    burritoTarget =
      {
  ...
  beam.mixRelease rec {
    ...
    src = fetchFromGitHub {
      owner = "elixir-lang";
      repo = "expert";
      rev = "60c39b33042a4128a929733ff31dc42e6e6336e8";
      hash = "sha256-KibkM7bjXra51jrp/mYxDrD/4wYDkWYklNdOrj+fPjg=";
    ...
    mixFodDeps = beam.fetchMixDeps {
      ...
      inherit version;
      inherit src;
      sha256 = "sha256-gFBwwjL1UmVDFEY2jpjwzEzTFu3zkOyKGmlog7mdLLM=";
      mixEnv = "prod";
    };
    ...
    buildInputs = [ systemd ]; # remove after https://github.com/elixir-lang/expert/issues/108
    nativeBuildInputs = [ makeWrapper zig_0_14 xz _7zz ];
