-- BASED ON:
-- https://github.com/kelly-lin/ranger.nvim/tree/main (MIT)
-- https://github.com/Kicamon/ranger.nvim (MIT)

local SELECTED_FILEPATH = vim.fn.tempname()
local MODE_FILEPATH = vim.fn.tempname()
...
local function open_win()
  ...
  local win_height = math.floor(ui.height * opts.ui.height + 0.5)
  local win_width = math.floor(ui.width * opts.ui.width + 0.5)
  local row = math.floor((ui.height - win_height) / 2 + 0.5)
  ...
  vim.api.nvim_set_option_value("filetype", "ranger", { buf = buf })
end
